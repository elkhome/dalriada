...
struct Player {
	...
	void drawplayer() {
		screen.sprite(sprite, Point(pos.x*8,pos.y*8-4), flip);
	}
	
	void drawplayer_top() {
		screen.sprite(sprite_top, Point(pos.x*8,pos.y*8-4), flip);
	}
